...
{/* Support */}
         <div className="support">
           <p className="support-text">Any Problem? <button onClick={() => window.open("https://chat.whatsapp.com/JK0iFcp09DYIEmkRD8wyCN", "_blank")} className="support-link">Chat with support</button></p>
         </div>
      </div>
    </div>
  );
